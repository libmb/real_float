...
/*   Updated: 2024/04/08 02:25:21 by Juyeong Maing    ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_mb_err	mb_real_float_add(
				...
				const t_mb_real *lhs,
				const t_mb_real *rhs);
t_mb_err	mb_real_float_multiply(
				void *context,
				t_mb_real **mut,
				const t_mb_real *lhs,
				const t_mb_real *rhs);
t_mb_err	mb_real_float_negate(
				void *context,
				t_mb_real **self);
t_mb_err	mb_real_float_is_greater_than_or_equal_to_four(
				void *context,
				const t_mb_real *self,
				bool *out);
